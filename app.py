...
@app.route('/cadastro-departamento.html', methods=["GET","POST"])
def cadastroDepartamento():
    return render_template('cadastro-departamento.html')
...
def cadastroGrupo():
    return render_template('cadastro-grupo.html', ativos=ATIVOS)
